...
class WindowsLifecycleTests(unittest.TestCase):
    def test_extracts_transition_fields_and_matrix_order(self):
        ...
        self.assertEqual(lifecycle.override_score2_floor_without_source, -17.0)
        self.assertEqual(lifecycle.override_score2_floor_with_source, -10.0)
        self.assertEqual(lifecycle.override_source_distance_squared, 215.0)
        ...
        self.assertEqual(lifecycle.override_source_margin, 0)
